/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 0066027501b5e20927f286eb3070271b)
...
declare namespace Cloudflare {
  interface Env {
    ...
    AI: Ai;
    ASSETS: Fetcher;
    // Optional Upstash Redis (fallback to KV if not provided)
